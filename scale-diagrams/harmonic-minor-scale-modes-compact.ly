  ...
  \fret-diagram-container {
    \left-column {
      ...
      \fret-diagram-verbose #`(
        ...
        (place-fret 3 4  "2" ,@fret-diagram-other-format)
        (place-fret 3 5 "♭3" ,@fret-diagram-triad-format)
        (place-fret 2 4 "♯4" ,@fret-diagram-other-format)
        (place-fret 2 5  "5" ,@fret-diagram-triad-format)
        (place-fret 2 7  "6" ,@fret-diagram-other-format)
        (place-fret 2 8 "♭7" ,@fret-diagram-pentatonic-format)
        (place-fret 1 5  "1" ,@fret-diagram-root-format)
      ...
      \fret-diagram-verbose #`(
        ...
        (place-fret 6 8 "♭4" ,@fret-diagram-other-format)
        (place-fret 5 5 "♭5" ,@fret-diagram-other-format)
        (place-fret 5 7 "♭6" ,@fret-diagram-other-format)
        (place-fret 5 8 "𝄫7" ,@fret-diagram-other-format)
        ...
        (place-fret 3 7 "♭5" ,@fret-diagram-other-format)
        ...
        (place-fret 1 7 "♭3" ,@fret-diagram-root-format)
        (place-fret 1 8 "♭4" ,@fret-diagram-other-format))
      \vspace #0.5
      "Ultralocrian"
    }
    ...
    \right-column {
      \fret-diagram-verbose #`(
        (place-fret 6 5  "7" ,@fret-diagram-light-other-format)
        (place-fret 6 6  "1" ,@fret-diagram-root-format)
        (place-fret 6 8  "2" ,@fret-diagram-pentatonic-format)
        (place-fret 5 5  "3" ,@fret-diagram-triad-format)
        (place-fret 5 6  "4" ,@fret-diagram-other-format)
        (place-fret 4 4 "♯5" ,@fret-diagram-other-format)
        (place-fret 4 5  "6" ,@fret-diagram-pentatonic-format)
        (place-fret 4 7  "7" ,@fret-diagram-other-format)
        (place-fret 4 8  "1" ,@fret-diagram-root-format)
        (place-fret 3 5  "2" ,@fret-diagram-pentatonic-format)
        ...
        (place-fret 1 5  "7" ,@fret-diagram-other-format)
      ...
      \fret-diagram-verbose #`(
        (place-fret 6 5  "7" ,@fret-diagram-light-other-format)
        (place-fret 6 6  "1" ,@fret-diagram-root-format)
        (place-fret 5 4 "♯2" ,@fret-diagram-other-format)
        (place-fret 5 5  "3" ,@fret-diagram-triad-format)
        ...
        (place-fret 3 7  "3" ,@fret-diagram-triad-format)
        (place-fret 2 5 "♯4" ,@fret-diagram-other-format)
